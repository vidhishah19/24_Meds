...
<!-- Portfolio -->
	<div class="portfolio" id="specials">
			<div class="container">
				<h2 class="w3_heade_tittle_agile">Categories We Provide</h2>
		    <p class="sub_t_agileits">Quality Care...</p>

			<div class="tabs tabs-style-bar">
				<nav>
					<ul>
						<li><a href="#section-bar-1" class="icon icon-box"><span>Ayurvedic</span></a></li>
						<li><a href="#section-bar-2" class="icon icon-display"><span>Generic</span></a></li>
						<li><a href="#section-bar-3" class="icon icon-upload"><span>Homeopathic</span></a></li>
					</ul>
				</nav>
				...
				<div class="content-wrap">
					...
					<section id="section-bar-1" class="agileits w3layouts">
						<div class="gallery-grids">
							<div class="col-md-4 col-sm-4 gallery-top">
								<a href="home.php">
									<figure class="effect-apollo">
                                                                            <img style="width:600px; height:400px;" src="images/chanca_piedra.jpg" alt="Health Plus" class="img-responsive">
										<figcaption></figcaption>
									</figure>
								</a>
							</div>
							<div class="col-md-4 col-sm-4 gallery-top">
								<a href="images/iyush.jpg" class="swipebox">
									<figure class="effect-apollo">
										<img style="width:600px; height:400px;" src="images/iyush.jpg" alt="Health Plus" class="img-responsive">
										<figcaption></figcaption>
									</figure>
								</a>
							</div>
							<div class="col-md-4 col-sm-4 gallery-top">
                                                            <a href="images/herbal_hills.jpg" class="swipebox">
									<figure class="effect-apollo">
                                                                            <img style="width:600px; height:400px;" src="images/herbal_hills.jpg" alt="Health Plus" class="img-responsive">
										<figcaption></figcaption>
									</figure>
								</a>
							</div>
							<div class="col-md-4 col-sm-4 gallery-top">
								<a href="images/pentacid.jpg" class="swipebox">
									<figure class="effect-apollo">
                                                                            <img style="width:600px; height:400px;" src="images/pentacid.jpg" alt="Health Plus" class="img-responsive">
										<figcaption></figcaption>
									</figure>
								</a>
							</div>
							...
							<div class="col-md-4 col-sm-4 gallery-top">
                                                            <a href="images/pirant.png" class="swipebox">
									<figure class="effect-apollo">
                                                                            <img style="width:600px; height:400px;" src="images/pirant.png" alt="Health Plus" class="img-responsive">
										<figcaption></figcaption>
									</figure>
								</a>
							</div>
