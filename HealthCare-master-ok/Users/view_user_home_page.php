...
<nav class="navbar navbar-default navbar-fixed-top">
  <div class="container-fluid ">
    <div class="navbar-header">       
     <a class="navbar-brand text-dark" href="#myPage"><strong>--24Meds--</strong></a>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox" >
      <div class="item active">
          <img src="../pic/banner3.jpg" alt="img1" width="1500" height="800" title="User Home Page">
  <div class="w3-display-middle w3-margin-top w3-center">
    <h1 class="w3-xxlarge w3-text-white"><ol class="w3-padding w3-white"><b>24 Meds, Quality We Care For You</b></ol></h1>
  </div>
    </div></div></div>
